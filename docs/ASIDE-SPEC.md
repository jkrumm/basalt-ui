# Aside Spec — the right-hand panel region _(waves 1, 2 and 4 delivered 2026-08-28, package half; chrome round 2026-08-30; wave 3 is still a sketch)_
...
| 3                         | `Histogram` panel kind · `MembershipToggle` over one key of a `field.multi`, off a `has`/`toggle` handle on the field (G14)                                                                                                                                                                                                                                                                                                                                                                                  | a second consumer page (argo) on the aside                            |
