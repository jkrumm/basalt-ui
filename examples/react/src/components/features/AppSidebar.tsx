...
import { BitcoinIcon, BookText, House, PackageSearch } from 'lucide-react'
import * as React from 'react'

import { Divider } from '../tremor/Divider.tsx'
import { Input } from '../tremor/Input.tsx'
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar {...props} className="bg-gray-50 dark:bg-gray-900">
