...
| `./charts`          | **free** | visx primitives / kinds / sparklines / hooks (re-exports the token layer too), incl. `XZoneRects` + `type XZoneSpec` (vertical x-range bands, `getX`-domain-keyed)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
